...
If the confidence intervals between corresponding coefficient are overlapping with each other, we consdier there is no significant difference between the model. And thus the indication of the coefficient is statistically appealing (not crap).
...
#          se = list(se_ols1, se_tsls1, se_ols2, se_tsls2, se_ols3, se_tsls3, se_ols4, se_tsls4),
          covariate.labels=c("product line", "product type", "order type", "retail country"), 
...
top10 <- tail(sort(ols_interact$coefficients),11)
```
