...
# Confidence intervals are given by the covariance matrix variance elements
# x1 estimated coefficent confidence interval
-1.96*sqrt(x.ar$asy.var.coef[1,1])+x.ar$ar[1]
1.96*sqrt(x.ar$asy.var.coef[1,1])+x.ar$ar[1]

# x1 actual coefficient
5/6

# x2 estimated coefficent confidence interval
-1.96*sqrt(x.ar$asy.var.coef[2,2])+x.ar$ar[2]
1.96*sqrt(x.ar$asy.var.coef[2,2])+x.ar$ar[2]

# x2 actual coefficient
-1/6

# x3 estimated coefficent confidence interval
-1.96*sqrt(x.ar$asy.var.coef[3,3])+x.ar$ar[3]
1.96*sqrt(x.ar$asy.var.coef[3,3])+x.ar$ar[3]

# x3 actual coefficient
0
```
...
abs(polyroot(c(1, -0.8090353, 0.0840377, 0.1805376)))
```
